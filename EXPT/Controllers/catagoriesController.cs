...
namespace EXPT.Controllers
{
    public class catagoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Catagories,Limit")] catagory catagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Catagories,Limit")] catagory catagory)
        {
            if (ModelState.IsValid)
            {
